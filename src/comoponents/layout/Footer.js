...
const Footer = () => {
  return (
    <footer style={{marginTop:"100px", bottom: "0",  flex}}>
      <Container fluid className="bg-secondary" style={{ backgroundColor: '#56CCF2' }}>
        <div className="d-flex justify-content-center align-items-center h-100">
          <h1 className="display-2 text-white mr-4" style={{ fontSize: '50px', fontWeight: '600' }}>
            The Generics
          </h1>
